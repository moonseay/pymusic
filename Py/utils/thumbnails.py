...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"Py/assets/Py.png")
        ...
        font = ImageFont.truetype("Py/assets/font2.ttf", 45)
        ImageFont.truetype("Py/assets/font2.ttf", 70)
        arial = ImageFont.truetype("Py/assets/font2.ttf", 30)
        ImageFont.truetype("Py/assets/font.ttf", 30)
