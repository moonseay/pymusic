...
from Py import Telegram, YouTube, app
from Py.misc import SUDOERS, _boot_
from Py.plugins.playlist import del_plist_msg
from Py.plugins.sudoers import sudoers_list
from Py.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from Py.utils.decorators.language import LanguageStart
from Py.utils.formatters import get_readable_time
from Py.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/tr4shcode"
                        ),
                    ],
                ]
            )
